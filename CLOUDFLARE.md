...
- The scheduled handler checks the allowlisted public GitHub repositories and deployed projects every 15 minutes. KV namespace `henokabraham-com-live-data` (`8936ecfe40dd4fc9a30d109c058baf60`) stores public snapshots only. Project checks older than 45 minutes are labelled as previous checks. The KSFO METAR feed and its "Live at SFO" panel were removed on 2026-09-13 at the owner's request; the stored `weather:v1` key expires on its own within a day. A blocked automated website check is reported as unverified, not an outage.
