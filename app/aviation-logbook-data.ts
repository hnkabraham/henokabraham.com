...
export const aviationLogbook: AviationEntry[] = [
  {
    ...
    note: 'The aircraft and airport featured in this site’s cinematic departure. This is a scene reference, not a record of a flight taken.',
    source: 'Departure scene',
