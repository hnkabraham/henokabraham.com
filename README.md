...
My personal site: **[henokabraham.com](https://henokabraham.com)**. It opens with an airborne Boeing 787-9. The page begins with a moving blue sky; scrolling brings the aircraft into frame, then carries the camera past its engine, wing and tail before pulling back into open sky. The flight reveals project previews and my flight log along the way, then leads into the full project board, route atlas, open-source work and contact form.
