...
My personal site: **[henokabraham.com](https://henokabraham.com)**. It opens with an airborne Boeing 787-9. The page begins with a moving blue sky; scrolling brings the aircraft past from behind the viewer into a look up one engine's tailpipe, then lets it fly on and away, wings flexed, banking gently into the distance. The flight reveals project previews and my flight log along the way, then leads into the full project board, route atlas, open-source work and contact form.
